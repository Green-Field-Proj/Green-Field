      ...
      <div className="product-list">
        {flashSaleProducts.map((product) => (
          <div key={product.id} className="product-card">
            <Card sx={{ maxWidth: 345 }} className="flashCard">
              <Box sx={{ position: 'relative', height: 350, width: 270 }}>
                ...
                >
                  <Typography variant="subtitle1" className="discount">{(product.discount * 100).toFixed(0)}%</Typography>
                </Box>
                <Box
                  sx={{
                    position: 'absolute',
              ...
              <CardContent>
                ...
                <div className="flash-price">
                  <p className="flashCardDiscount">
                    ${ (product.price * (1 - product.discount)).toFixed(2) }
                  </p>
                  <p className="flashCardPrice">${product.price.toFixed(2)}</p>
                </div>
